import argparse
import requests
import jsonAPI_KEY = "AIzaSyAWd44FwD80rlxc8S6CZYUdjRQw_9cjeWg"def gm_search(params):    request_string = "https://maps.googleapis.com/maps/api/place/textsearch/json?query={0}&key={1}"
